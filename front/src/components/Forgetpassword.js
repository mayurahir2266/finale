        ...
        <div class="card text-center" className='card' >
          ...
          <div class="card-body px-5">
            ...
            <div class="form-outline">
              ...
              <input type="email" id="typeEmail" placeholder='Enter your email' onChange={(e) => { setemail(e.target.value) }} class="form-control my-3" />
            </div>
            ...
            <div class="d-flex justify-content-between mt-4">
              ...
              <Link to='/register'><a class="l1" href="#">Register</a></Link>
            </div>
          </div>
        </div>
      </div>
